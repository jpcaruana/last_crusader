defmodule LastCrusader.Utils.IdentifierTest do
  ...
  test "user profile URL should be valid" do
    ...
    assert :valid ==
             IdentifierValidator.validate_user_profile_url("https://example.com/users?id=100")
  end
  ...
  test "profile URL should not contain a double-dot path segment" do
    assert :invalid ==
             IdentifierValidator.validate_user_profile_url("https://example.com/foo/../bar")
  end

  test "profile URL should not contain a username and password" do
    assert :invalid ==
             IdentifierValidator.validate_user_profile_url("https://user:pass@example.com/")
  end
